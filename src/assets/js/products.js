const _products = [
  ...
  { title: 'Surgical Records Report System', sub: 'SRRS-手術記錄報告系統', img: 'productMobile_image/srrs.png', 
    contents: ['手術記錄是電子病歷中重要的一環,撰寫手術記錄是外科醫生手術後必要的基本工作項目,其內容的充分性與資料的正確性攸關醫療品質的良竄,並影響未來醫學研究資料分析的正確性與便利性。','由於外科系各次專科對進行的手術有不同的內容紀錄需求,其紀錄項目與格式亦常隨著臨床需求改變而更動,因此開發及維護高品質的手術記錄資訊系統需要耗費龐大的資源人力。','SRRS系統根據醫院需求開發作業環境,節省外科手術資訊管理之工時、提升手術作業流程,改善醫院品質管制。','本系統以衛生署訂定的手術記錄基本内容為基準。'], 
